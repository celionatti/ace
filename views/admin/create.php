...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="card">
        <h2 style="font-size: 1.8rem; margin-bottom: 2rem;" class="gradient-text">Create New Post</h2>
        
        <form action="{{ route('admin/create') }}" method="POST" novalidate>
            {!! csrf_field() !!}
            ...
            <button type="submit" class="btn btn-primary" style="padding: 0.75rem 1.5rem; border-radius: 0.5rem; font-weight: 600; cursor: pointer;">Publish Post</button>
        </form>
    </div>
</div>
@endsection
